...
# Data for "Energy Constrained" scenario
coverage_data = [85.8, 83.4, 81.9, 82.7, 80.5, 79.8, 71.5, 87.9, 85.6, 84.1, 84.9, 82.7, 82.0, 77.5]
drone_data = [18, 19, 20, 19, 20, 21, 25, 17, 18, 19, 18, 19, 20, 22]

def generate_replicated_figure_12():
    print("Generating Replicated Figure 12 (Energy Constrained, PNG Only)...")
    ...
    ax1.set_title('Coverage Performance - Energy Constrained', fontweight='bold', pad=15)
    ...
    ax2.set_title('Drone Efficiency - Energy Constrained', fontweight='bold', pad=15)
    ...
    # Main Figure Title
    fig.suptitle('Test Case: Energy Constrained - Algorithm Performance Analysis', fontsize=22, fontweight='bold', y=0.98)
    ...
    # Save PNG Only
    png_path = os.path.join(OUTPUT_DIR, "fig_12_FINAL_REPLICATED.png")
    plt.savefig(png_path, dpi=1000, bbox_inches='tight')
    plt.close()
    
    print(f"SUCCESS: Replicated Figure 12 (PNG) saved to:\n  {png_path}")

if __name__ == "__main__":
    generate_replicated_figure_12()
