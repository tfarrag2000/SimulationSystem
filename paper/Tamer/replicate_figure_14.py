...
# Data for "Mixed Terrain" scenario
coverage_data = [80.7, 78.9, 77.2, 78.8, 76.4, 75.8, 68.1, 83.1, 81.2, 79.6, 80.9, 78.7, 78.0, 73.8]
drone_data = [16, 17, 18, 17, 18, 19, 23, 15, 16, 17, 16, 17, 18, 20]

def generate_replicated_figure_14():
    print("Generating Replicated Figure 14 (Mixed Terrain, PNG Only)...")
    ...
    ax1.set_title('Coverage Performance - Mixed Terrain', fontweight='bold', pad=15)
    ...
    ax2.set_title('Drone Efficiency - Mixed Terrain', fontweight='bold', pad=15)
    ...
    # Main Figure Title
    fig.suptitle('Test Case: Mixed Terrain - Algorithm Performance Analysis', fontsize=22, fontweight='bold', y=0.98)
    ...
    # Save PNG Only
    png_path = os.path.join(OUTPUT_DIR, "fig_14_FINAL_REPLICATED.png")
    plt.savefig(png_path, dpi=1000, bbox_inches='tight')
    plt.close()
    
    print(f"SUCCESS: Replicated Figure 14 (PNG) saved to:\n  {png_path}")

if __name__ == "__main__":
    generate_replicated_figure_14()
