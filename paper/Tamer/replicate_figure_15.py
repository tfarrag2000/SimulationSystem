...
# Data for "Emergency Response" scenario
coverage_data = [88.4, 86.1, 84.8, 85.5, 83.2, 82.9, 74.4, 90.8, 88.7, 86.4, 87.3, 85.6, 84.8, 80.9]
drone_data = [13, 14, 15, 14, 15, 16, 19, 12, 13, 14, 13, 14, 15, 17]

def generate_replicated_figure_15():
    print("Generating Replicated Figure 15 (Emergency Response, PNG Only)...")
    ...
    ax1.set_title('Coverage Performance - Emergency Response', fontweight='bold', pad=15)
    ...
    ax2.set_title('Drone Efficiency - Emergency Response', fontweight='bold', pad=15)
    ...
    # Main Figure Title
    fig.suptitle('Test Case: Emergency Response - Algorithm Performance Analysis', fontsize=22, fontweight='bold', y=0.98)
    ...
    # Save PNG Only
    png_path = os.path.join(OUTPUT_DIR, "fig_15_FINAL_REPLICATED.png")
    plt.savefig(png_path, dpi=1000, bbox_inches='tight')
    plt.close()
    
    print(f"SUCCESS: Replicated Figure 15 (PNG) saved to:\n  {png_path}")

if __name__ == "__main__":
    generate_replicated_figure_15()
