...
# Data for "Wide Area" scenario
coverage_data = [87.2, 85.9, 83.7, 84.5, 82.8, 82.1, 73.8, 89.4, 88.1, 85.9, 86.7, 85.0, 84.3, 79.8]
drone_data = [15, 16, 17, 16, 17, 18, 22, 14, 15, 16, 15, 16, 17, 19]

def generate_replicated_figure_11():
    print("Generating Replicated Figure 11 (Wide Area, PNG Only)...")
    ...
    ax1.set_title('Coverage Performance - Wide Area', fontweight='bold', pad=15)
    ...
    ax2.set_title('Drone Efficiency - Wide Area', fontweight='bold', pad=15)
    ...
    # Main Figure Title
    fig.suptitle('Test Case: Wide Area - Algorithm Performance Analysis', fontsize=22, fontweight='bold', y=0.98)
    ...
    # Save PNG Only
    png_path = os.path.join(OUTPUT_DIR, "fig_11_FINAL_REPLICATED.png")
    plt.savefig(png_path, dpi=1000, bbox_inches='tight')
    plt.close()
    
    print(f"SUCCESS: Replicated Figure 11 (PNG) saved to:\n  {png_path}")

if __name__ == "__main__":
    generate_replicated_figure_11()
